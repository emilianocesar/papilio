...
public class JavaPackageImpl extends EPackageImpl implements JavaPackage {
	...
	public EClass getInstanceSpecification() {
		if (instanceSpecificationEClass == null) {
			instanceSpecificationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(JavaPackage.eNS_URI).getEClassifiers().get(132);
		}
	 ...
	 * @generated
	 */
	public EReference getInstanceSpecification_InstanceType() {
	 ...
	 * @generated
	 */
	public EReference getInstanceSpecification_Usages() {
	 ...
	 * @generated
	 */
	public EReference getInstanceSpecification_CreationExpression() {
