 ...
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.TypeImpl#getInstances <em>Instances</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TypeImpl extends NamedElementImpl implements Type {
	...
	public EList<InstanceSpecification> getInstances() {
		if (instances == null) {
			instances = new EObjectContainmentEList<InstanceSpecification>(InstanceSpecification.class, this, JavaPackage.TYPE__INSTANCES);
		}
		return instances;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case JavaPackage.TYPE__INSTANCES:
