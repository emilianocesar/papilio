 ...
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.AbstractTypeDeclarationImpl#getInstances <em>Instances</em>}</li>
...
public abstract class AbstractTypeDeclarationImpl extends BodyDeclarationImpl implements AbstractTypeDeclaration {
	 ...
	 * @ordered
	 */
	protected EList<InstanceSpecification> instances;
	 ...
	 * @generated
	 */
	public EList<InstanceSpecification> getInstances() {
		if (instances == null) {
			instances = new EObjectContainmentEList<InstanceSpecification>(InstanceSpecification.class, this, JavaPackage.ABSTRACT_TYPE_DECLARATION__INSTANCES);
		}
		return instances;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case JavaPackage.ABSTRACT_TYPE_DECLARATION__INSTANCES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case JavaPackage.ABSTRACT_TYPE_DECLARATION__INSTANCES:
				getInstances().clear();
				getInstances().addAll((Collection<? extends InstanceSpecification>)newValue);
				return;
			case JavaPackage.ABSTRACT_TYPE_DECLARATION__BODY_DECLARATIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Type.class) {
			switch (derivedFeatureID) {
				...
				case JavaPackage.ABSTRACT_TYPE_DECLARATION__INSTANCES: return JavaPackage.TYPE__INSTANCES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Type.class) {
			switch (baseFeatureID) {
				...
				case JavaPackage.TYPE__INSTANCES: return JavaPackage.ABSTRACT_TYPE_DECLARATION__INSTANCES;
				default: return -1;
			}
		}
