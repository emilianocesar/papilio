...
public class ASConstructorDeclarationProxy extends ASConstructorDeclaration
		implements ASDeclarationProxy {

	private ASConstructorDeclaration declaration;
	...
	public void setDeclaration(ASDeclaration declaration) {
		this.declaration = (ASConstructorDeclaration) declaration;
	}
