...
public class Context {
	...
	/**
	 * Obtiene el id de variable para la declaracion pasada como parametro
	 * El id de variable esta dado por el scope actual mas el nombre de la variable
	 * Si ya existe una variable con ese mismo id, se agrega a la misma un sufijo entero incremental
	 * @param declaration La declaracion para la que se desea obtener el nombre completo
	 * @return El nombre completo para la variable
	 */
	public String getFullVarDeclarationName(VariableDeclaration declaration) {
		
		StringBuilder fullVariableName = new StringBuilder(this.getCurrentScope());
	...
	public String getFullMethodDeclarationName(AbstractMethodDeclaration declaration) {
		
		//el nombre completo del method esta dado por el currentscope, leerlo de ah?
	...
	public void setCurrentClassDeclaration(AbstractTypeDeclaration classDeclaration) {
	...
	public void removeFromCurrentScope(NamedElement scopeElement) {
		this.currentScope = this.removeFromScope(this.currentScope, scopeElement);
	}
